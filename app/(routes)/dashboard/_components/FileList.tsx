...
<div className="overflow-x-auto">
 ...
 <td className="whitespace-nowrap px-4 py-2 text-gray-700"><Image className='rounded-full' src={user?.picture} alt='user' width={30} height={30} /></td>
 <td className="whitespace-nowrap px-4 py-2 text-gray-700"><DropdownMenu>
