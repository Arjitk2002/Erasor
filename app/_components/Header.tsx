    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="sm:flex sm:gap-4">
          ...
          <a
            className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-black transition hover:text-slate-800 sm:block dark:bg-gray-800 dark:text-white dark:hover:text-white/75"
            href="#"
          >
            <RegisterLink>
            Register
